...
<div id="container">
  <main>
    ...
    <nav>
       ...
       <a class="button v" target="_blank" href="https://github.com/KayoOkazaki/crescent_ci/blob/master/application/views/admin/product/product_delete_v.php">View</a>&nbsp&nbsp
