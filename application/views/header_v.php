    ...
    <header class="navbar navbar-default navbar-fixed-top" role="banner">
      <div class="container">
        ...
        <h1 class="navbar-header">
          <a href="<?php echo base_url('home');?>" class="navbar-brand"><img src="<?php echo base_url('images/logo01.png');?>" alt="LOGO"></a>
        </h1><!-- /.navbar-header -->
        <nav class="navbar-collapse collapse" id="navigation" role="navigation">
          <ul class="nav navbar-nav">
            <li><a href="<?php echo base_url('home'); ?>">ホーム<span>HOME</span></a></li>
            <li><a href="<?php echo base_url('home/about_c'); ?>">会社概要<span>ABOUT</span></a></li>
